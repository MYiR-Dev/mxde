...
void SystemContentWidget::createSettingGroupBox()
{
    ...
    mSerialOpenButton->setObjectName("rs485Button");
...
void SystemContentWidget::createSendGroupBox()
{
    ...
    m_SendPushButton->setObjectName("rs485Button");
...
void SystemContentWidget::createRecvGroupBox()
{
    ...
    m_ClearPushButton->setObjectName("rs485Button");
...
void SystemContentWidget::setCurrentConfigure(QStringList list)
{
    ...
    QMessageBox::information(this, tr("Warning"), tr("RS485 had opened!Now use the opened configuration!"));
}
void SystemContentWidget::on_openPushButton_clicked()
{
    if(!openFlag)
    {
        ...
        if(serialPortStr == "")
        {
            QMessageBox::information(this, tr("Warning"), tr("Do not find any rs485 port!"));
            return;
        }
...
void SystemContentWidget::on_sendPushButton_clicked()
{
    ...
    {
        QMessageBox::information(this, tr("Warning"), tr("Please open rs485 port first!"));
    }
}
